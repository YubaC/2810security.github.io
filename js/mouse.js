...
if (!IsPc()) {
    ...
    document.write('<img id="myImg" src="https://cdn.jsdelivr.net/gh/YubaC/2810security.github.io@latest/images/mouse.png" STYLE="position:absolute;TOP:0pt;LEFT:0pt;width=103;height=28;Z-INDEX:2;">');
    document.write('</div>');
}